...
public class Tarjeta {
	...
	public void setCodigo(String codigo) throws Exception {
		boolean comprobar = codigo.matches("[A-Z]{6}[0-9]{6}");
		if (codigo.length() > 12) {
			throw new Exception("Tarjeta invalida por limite de caracteres");
		} 
		if(!comprobar){
			throw new Exception("Tarjeta invalida por validez de caracteres");
		}
		this.codigo = codigo;
	}
	...
	public double getCalcularPuntajeFinal() {
		return calcularPuntajeFinal();
	}
	...
	public String toString() {
		return "Tarjeta [idTarjeta=" + idTarjeta + ", codigo=" + codigo + ", codigoCliente=" + codigoCliente
				+ ", puntaje final= " + calcularPuntajeFinal() + "]";
	}
